...
async function getHistory(logindata, instance) {
    /*
  ...
  */
    if (typeof instance == "undefined") {
        throw new Error("instance is undefined. wait for the instance to be resolved and then execute code");
    }
    ...
    for (let i = 1; i < navLength; i++) {
        ...
        historypages.push(instance.get(`/users/${logindata.username}/readings?page=${i}`));
    }
