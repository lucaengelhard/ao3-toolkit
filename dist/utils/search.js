 ...
 * @returns an object containing the current page number, maximum pages and search results
 */
export async function advancedWorkSearch(search, index) {
    let page = "";
    if (!(index == 1 || typeof index == "undefined")) {
        page = `page=${index}&`;
    }
 ...
 * @returns an object containing the current page number, maximum pages and search results
 */
export async function advancedPeopleSearch(search, index) {
 ...
 * @returns an object containing the current page number, maximum pages and search results
 */
export async function advancedBookmarkSearch(search, index) {
    if (typeof index == "undefined") {
        index = 1;
    }
    let page = "";
        ...
        bookmarks.forEach((bookmark) => {
            ...
            if (type == "series") {
                ...
                let info = {
                    ...
                    stats: {
                        words: parseInt($(".stats dt:contains('Words')").next().text().replace(",", "")),
                        bookmarks: parseInt($(".stats dt:contains('Bookmarks')").next().text()),
 ...
 * @returns an object containing the current page number, maximum pages and search results
 */
export async function advancedTagSearch(search, index) {
    if (typeof index == "undefined") {
        index = 1;
    }
    let page = "";
