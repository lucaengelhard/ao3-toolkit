...
export class Work {
    ...
    #cached;
    #context;
    constructor(info, content, userdata, context) {
...
export class WorkList {
    ...
    sortByChaptersWritten() {
        this.#works.sort((a, b) => {
            return (a.info.stats.chapters.chaptersWritten -
                b.info.stats.chapters.chaptersWritten);
        });
    }
    sortByChaptersMax() {
        this.#works.sort((a, b) => {
            return (a.info.stats.chapters.chaptersMax - b.info.stats.chapters.chaptersMax);
        });
    }
    sortByCollectionNumber() {
        this.#works.sort((a, b) => {
            let aNum = 0;
            let bNum = 0;
            if (typeof a.info.collections == "undefined" ||
                ...
                if (typeof b.info.collections == "undefined" &&
    ...
    sortByTitle() {
        this.#works.sort((a, b) => {
            let fa = a.info.title.toLowerCase(), fb = b.info.title.toLowerCase();
            if (fa < fb) {
                return -1;
            }
            if (fa > fb) {
    ...
    sortByAuthor() {
        this.#works.sort((a, b) => {
            let fa = a.info.author.authorName.toLowerCase(), fb = b.info.author.authorName.toLowerCase();
            if (fa < fb) {
                return -1;
            }
            if (fa > fb) {
    ...
    sortByLastRead() {
        this.#works.sort((a, b) => {
            if (typeof a.history == "undefined" || typeof b.history == "undefined") {
                ...
                else if (typeof a.history !== "undefined" &&
                    typeof b.history !== "undefined") {
                    let da = a.history.lastVisit.getTime(), db = b.history.lastVisit.getTime();
                    return da - db;
                }
            }
            return 0;
