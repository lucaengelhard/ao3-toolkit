...
export class Session {
    ...
    async login() {
        ...
        let instance = wrapper(axios.create({
    ...
    async getHistory(span) {
        return await ao3.getList(this.#logindata, this.#instance, ao3.Listtype.History, span);
    }
    /**
    ...
    async getBookmarks(span) {
        return await ao3.getList(this.#logindata, this.#instance, ao3.Listtype.Bookmarks, span);
    }
}
